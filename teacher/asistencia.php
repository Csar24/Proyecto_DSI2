        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Asistencia Diaria</h1>
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <!--TABLA DE REGISTROS-->
                        ...
                        <div class="col-lg-12">
                            <div id="mensaje" class="alert alert-success alert-dismissible fade show text-center" role="alert" style="display: none;"></div>
                        </div>
                        <div class="col-lg-12">
                            <!---->
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="../controllers/asistencia.php" method="POST">
                                        <div class="row">
                                            <div class="form-group row col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="idProfesor" value="<?php echo $sesionU; ?>">
                                                </div>
                                            </div>
                                        </div>
