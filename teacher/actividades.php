<?php 
    ...
    $actividades = consultarActividades($sesionU);
    $gadosMaterias = consultarMateriaProfesor($sesionU);
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Grado - Materia:</label>
                                            <div class="col-sm-8">
                                                <select class="form-select form-control" id="gradoMateria">
                                                    <?php foreach ($gadosMaterias as $gm) {
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Nombre Actividad:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nomAct">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarAct" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped" id="dataTable">
                                        ...
                                        <?php foreach($actividades as $a){ 
                                            ...
                                            $descrip = $a['descripcion_actividad'];
                                            $grado = $a['nombre_grado'];
                                            $mater = $a['nombre_materia'];
                                            $porce = $a['ponderacion'];?>
                                            <tr>
                                                <td scope="row"><?php echo $id; ?></td>
                                                <td><?php echo $nombre; ?></td>
                                                <td><?php echo $grado; ?></td>
                                                <td><?php echo $mater; ?></td>
                                                <td><?php echo $descrip; ?></td>
                                                <td><?php echo $porce; ?></td>
                                                <td>
