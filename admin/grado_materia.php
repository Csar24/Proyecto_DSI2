<?php 
    ...
    $gradoMat = consultarGradoMateria();
...
<head>
    ...
    <script src="../js/jsGradoMateria.js"></script>
</head>
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <h3 style="width: 100%;text-align:center">Materias y Grados</h3>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <!--TABLA DE REGISTROS-->
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <?php foreach ($gradoMat as $gm) { $id = $gm['id_grado_materia']; $grade = $gm['nombre_grado']; $mate = $gm['nombre_materia']; ?>
                                            <tr>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-4 col-form-label">Materia:</label>
                                            <div class="col-sm-8">
                                                <select class="form-select form-control" id="idMateria">
