                                ...
                                <div class="card-body">
                                    <table class="table table-striped" id="dataTable">
                                        ...
                                        <?php foreach ($users as $us) {
                                            $id = $us['id_usuario']; $nombre = $us['nombre']; $apellidos = $us['apellidos']; $usuario = $us['usuario']; $acceso = $us['tp']; ?>
                                            <tr>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarDU" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
