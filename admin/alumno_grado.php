<?php 
    ...
    $alumnoGrado = consultarAlumnoGrado();
...
<head>
    ...
    <script src="../js/jsAlumnoGrado.js"></script>
</head>
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <h3 style="width: 100%;text-align:center">Alumnos y sus grados</h3>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <!--TABLA DE REGISTROS-->
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <?php foreach ($alumnoGrado as $ag) { $id = $ag['id_alumno']; $nombreC = $ag['nombreC']; $gradoE = $ag['nombre_grado']; ?>
                                            <tr>
                                                <td scope="row"><?php echo $id; ?></td>
                                                <td><?php echo $nombreC; ?></td>
                                                <td><?php echo $gradoE; ?></td>
                                                <td>
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-4 col-form-label">Alumno:</label>
                                            <div class="col-sm-8">
                                                <select class="form-select form-control" id="idAlumno">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-4 col-form-label">Grado:</label>
                                            <div class="col-sm-8">
                                                <select class="form-select form-control" id="idGrado">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarAG" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
