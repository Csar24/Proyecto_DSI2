<?php 
    ...
    $tiposAcceso = consultarTiposAcceso();
...
<head>
    ...
    <script src="../js/jsAcceso.js"></script>
</head>
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-4 col-form-label">Nombre Acceso:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nombreAG">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarDA" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
