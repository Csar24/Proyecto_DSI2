                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <?php foreach ($grado as $g) { $id = $g['id_grado']; $nombre = $g['nombre_grado'];?>
                                            <tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nombreGG">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarGrad" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
