...
<head>
    ...
    <script src="../js/jsMateria.js"></script>
</head>
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <h3 style="width: 100%;text-align:center">Tipos de Acceso al Sistema</h3>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <!--TABLA DE REGISTROS-->
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <?php foreach ($materias as $m) { $id = $m['id_materia']; $nombre = $m['nombre_materia'];?>
                                            <tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-4 col-form-label">Nombre de la Materia:</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="nombreGMat">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button id="guardarMat" class="btn btn-primary">Registrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
